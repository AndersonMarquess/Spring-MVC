    ...
    <section id="index-section" class="container middle">
        ...
        <ul class="clearfix book-collection">
            ...
            <c:forEach items="${produtos}" var="produto">
                <li>
                    <a href="produtos/detalhe/${produto.id}" class="block clearfix">
                        <h2 class="product-title">${produto.titulo}</h2>
                        <img width="143" height="202" src="https://cdn.shopify.com/s/files/1/0155/7645/products/java8-featured_large.png?v=1411490181"
        ...
        <ul id="cdc-diferenciais" class="clearfix">
            ...
            <li class="col-right">
                ...
                <p>
                    <span class="sprite" id="sprite-caelum"></span> Desenvolvedores experientes que avaliam e revisam
                    os livros constantemente.
                </p>
            </li>
        </ul>
