...
<body>
    ...
    <header id="layout-header">
        <div class="clearfix container">
            ...
            <div id="header-content">
                <nav id="main-nav">
                    <ul class="clearfix">
                        <li><a href="ProjetoSpringMVC/carrinho/itens" rel="nofollow">Carrinho (${carrinhoCompras.quantidade})</a></li>
    ...
    <section class="container middle">
        ...
        <table id="cart-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="numeric-cell">${item.produto.getPrecoPara(item.tipoPreco) }</td>
        ...
        <ul id="collection" class="related-books">
            <li class="col-left"><a href="/products/livro-plsql" class="block clearfix book-suggest" data-book="PL/SQL: Domine a linguagem do banco de dados Oracle">
                    ...
                    <form action="" method="POST" id="ss-form" class="form-newsletter">
                        <ul>
                            <li><input type="hidden" name="pageNumber" value="0" /><input type="hidden" name="backupCache"
                                    value="" /><input type="email" name="entry.0.single" value="" class="ss-q-short" id="entry_0"
