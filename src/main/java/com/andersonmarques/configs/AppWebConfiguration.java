...
@EnableCaching
@EnableWebMvc
@ComponentScan(basePackageClasses = { HomeController.class, ProdutoDao.class, FileSaver.class, CarrinhoCompras.class }) // Classes
																														// componentes/bean
public class AppWebConfiguration implements WebMvcConfigurer {
	...
	public InternalResourceViewResolver internalResourceViewResolver() {
		...
		// O Bean fica disponível na JSP, nome da classe com a primeira letra em
		// minúsculo.
